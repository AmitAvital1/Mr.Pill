...
export function MrPillLogo(scale?: number, home?: boolean, position?: "absolute" | "relative" | "static") {
  ...
  return <PopButton EnableRotation={true} ButtonContent={logo} BackgroundColor="white" ButtonScale={scale? scale: 1} Position={position} ButtonAction={()=>{if (!home) router.back()}}/>
}
